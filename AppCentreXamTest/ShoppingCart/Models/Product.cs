...
namespace ShoppingCart.Models
{
    ...
    public class Product : INotifyPropertyChanged
    {
        ...
        public string Name
        {
            get { return CultureInfo.CurrentUICulture.Name == "yo-NG" ? YorubaName : EngName; }
            set { }
        }

            [DataMember(Name = "name")] private string EngName { get; set; }
        [DataMember(Name = "yorubaname")] private string YorubaName { get; set; }
        ...
        public string Description
        {
            get
            {
                return CultureInfo.CurrentUICulture.Name == "yo-NG" ? YorubaDescription : EngDescription;
            }
            set { }
        }
        [DataMember(Name = "description")] private string EngDescription { get; set; }
        [DataMember(Name = "yorubadescription")] private string YorubaDescription { get; set; }
