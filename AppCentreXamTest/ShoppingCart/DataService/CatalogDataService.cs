                ...
                if (response != null && response.IsSuccessStatusCode)
                {
                    ...
                    if (result != null)
                    {
                        ...
                        if (productsEntity != null)
                            Products = App.Mapper.Map<List<ProductEntity>, List<Product>>(productsEntity);
                    }
                }
            }
            catch (HttpRequestException ex)
                ...
                if (response != null && response.IsSuccessStatusCode)
                {
                    ...
                    if (result != null)
                    {
                        ...
                        if (paymentsEntity != null)
                            Payments = App.Mapper.Map<List<PaymentEntity>, List<Payment>>(paymentsEntity);
                    }
                }
            }
            catch (HttpRequestException ex)
            ...
            try
            {
                ...
                if (response != null && response.IsSuccessStatusCode)
                {
                    ...
                    if (result != null)
                    {
                        ...
                        if (productEntity != null) Product = App.Mapper.Map<ProductEntity, Product>(productEntity);
                    }
                }
            }
            catch (HttpRequestException ex)
                ...
                if (response != null && response.IsSuccessStatusCode)
                {
                    ...
                    if (result != null)
                    {
                        ...
                        if (reviewsEntity != null)
                            Reviews = App.Mapper.Map<List<ReviewEntity>, List<Review>>(reviewsEntity);
                    }
                }
            }
            catch (HttpRequestException ex)
