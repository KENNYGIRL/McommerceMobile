                ...
                if (response != null && response.IsSuccessStatusCode)
                {
                    ...
                    if (result != null)
                    {
                        ...
                        if (userAddresses != null)
                            Addresses = App.Mapper.Map<List<AddressEntity>, List<Address>>(userAddresses);
                    }
                }
            }
            catch (HttpRequestException ex)
            ...
            try
            {
                ...
                if (response != null && response.IsSuccessStatusCode)
                {
                    ...
                    if (result != null)
                    {
                        ...
                        if (userCards != null) UserCards = App.Mapper.Map<List<UserCardEntity>, List<UserCard>>(userCards);
                    }
                }
            }
            catch (HttpRequestException ex)
