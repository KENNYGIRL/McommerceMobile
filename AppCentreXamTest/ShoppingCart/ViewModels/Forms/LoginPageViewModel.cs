...
namespace ShoppingCart.ViewModels.Forms
{
    ...
    public class LoginPageViewModel : LoginViewModel
    {
        ...
        /// </summary>
        public LoginPageViewModel(IUserDataService userDataService, string callerPage)
        {
        ...
        private void MessageCenterSubmitAsync(RecorderViewModel arg1, PredictionData data)
        {
            Device.BeginInvokeOnMainThread(async () =>
            {
                ...
                if (data.ClassId == "Back or Go back" && data.Probability > 70.0)
                {
                    await Application.Current.MainPage.DisplayAlert("Error", "Incorrect data returned. Please record your command again or contact support", "Cancel", "ok");
                }
                else if (data.ClassId == "Login" && data.Probability > 70.0)
                {
