...
namespace ShoppingCart.Views.TestNavigation
{
    /// <summary>
    ...
    public partial class SongsPlayListPage : ContentPage
    {
        ...
        public SongsPlayListPage()
        {
            ...
            var data = new MockDataService.CatalogDataService();
            BindingContext = data.Products;
        }
        ...
        {
            var page = new Recorder.Recorder(false, StringResource.RecordYourVoice, "Record Your voice", GetType().Name);
